const PerfumeIcon = ({ className }) => {
    return (
        <svg
            viewBox="0 0 148.19 134.04"
        ...
        >
            ...
            <g>
                <g>
                    <path d="m24.94,111.93c0,2.5-2.03,4.53-4.53,4.53s-4.53-2.03-4.53-4.53,2.03-4.53,4.53-4.53,4.53,2.03,4.53,4.53Z" />
                    <path d="m133.2,29.58c0,2.5-2.03,4.53-4.53,4.53s-4.53-2.03-4.53-4.53,2.03-4.53,4.53-4.53,4.53,2.03,4.53,4.53Z" />
                </g>
                <g>
                    <circle cx="118.8" cy="126.15" r="3.1"
                        fill="#e2e2e2" />
                    <path d="m23.94,47.53c0,1.71-1.39,3.1-3.1,3.1s-3.1-1.39-3.1-3.1,1.39-3.1,3.1-3.1,3.1,1.39,3.1,3.1Z" />
                </g>
            </g>
            ...
            {/* small filled dots */}
            <circle cx="118.8" cy="126.15" r="3.1" />
            <circle cx="20.84" cy="47.53" r="3.1"  fill="#e2e2e2" />
        </svg>
    );
};
